...
function _G.__PVPW__TEST_ITEMS_EN__Test()
  mod.testReporter.StartTestRun("global_items_en_all")
...
function _G.__PVPW__TEST_ITEMS_EN__Test_Sound()
  mod.testReporter.StartTestRun("global_items_en_sound")
  mod.testReporter.StartTestClass(className)

  mod.testHelper.TestShouldHaveASoundTestForEachSpell(me, className)
end

function _G.__PVPW__TEST_ITEMS_EN__Test_Sound_Down()
  mod.testReporter.StartTestRun("global_items_en_sound_down")
  mod.testReporter.StartTestClass(className)

  mod.testHelper.TestShouldHaveASoundDownTestForSpellsThatFade(me, className)
end

function _G.__PVPW__TEST_ITEMS_EN__Test_Sound_Enemy_Avoid()
  mod.testReporter.StartTestRun("global_items_en_sound_avoid")
  mod.testReporter.StartTestClass(className)

  mod.testHelper.TestShouldHaveAnEnemyAvoidSoundTestForEachSpell(me, className)
end

function _G.__PVPW__TEST_ITEMS_EN__Test_Sound_Self_Avoid()
  mod.testReporter.StartTestRun("global_items_en_sound_self_avoid")
  mod.testReporter.StartTestClass(className)

  mod.testHelper.TestShouldHaveASelfAvoidSoundTestForEachSpell(me, className)
end

function _G.__PVPW__TEST_ITEMS_EN__Test_Parse()
  mod.testReporter.StartTestRun("global_items_en_parse")
  mod.testReporter.StartTestClass(className)

  mod.testHelper.TestShouldHaveAParseTestForEachSpell(me, className)
end

function _G.__PVPW__TEST_ITEMS_EN__Test_Parse_Down()
  mod.testReporter.StartTestRun("global_items_en_parse_down")
  mod.testReporter.StartTestClass(className)

  mod.testHelper.TestShouldHaveAParseDownTestForSpellsThatFade(me, className)
end

function _G.__PVPW__TEST_ITEMS_EN__Test_Parse_Crit()
  mod.testReporter.StartTestRun("global_items_en_parse_crit")
  mod.testReporter.StartTestClass(className)

  mod.testHelper.TestShouldHaveAParseCritTestForSpellsThatCanCrit(me, className)
end

function _G.__PVPW__TEST_ITEMS_EN__Test_Parse_Enemy_Avoid()
  mod.testReporter.StartTestRun("global_items_en_parse_avoid")
  mod.testReporter.StartTestClass(className)

  mod.testHelper.TestShouldHaveAnEnemyAvoidParseTestForEachSpell(me, className)
end

function _G.__PVPW__TEST_ITEMS_EN__Test_Parse_Self_Avoid()
  mod.testReporter.StartTestRun("global_items_en_parse_self_avoid")
  mod.testReporter.StartTestClass(className)
